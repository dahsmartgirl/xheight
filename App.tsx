...
const App: React.FC = () => {
  ...
  return (
    <div className="w-full h-[100dvh] bg-white flex flex-col font-['Inter'] overflow-hidden">
      ...
      {/* Header */}
      <header className="h-[54px] shrink-0 border-b border-thin border-[#D9D9D9] flex items-center justify-between px-4 lg:px-[24px] bg-white z-50 relative overflow-visible">
        <div className="flex items-center gap-4 overflow-visible">
            ...
            <div className="flex items-center select-none overflow-visible">
                <div className="h-[16px] lg:h-[20px] w-auto overflow-visible flex items-center">
                    <svg width="83" height="25" viewBox="0 0 83 25" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-full w-auto block overflow-visible shrink-0">
        ...
        <button 
            ...
            className="flex items-center gap-[6px] bg-[#14110F] text-white px-3 py-1.5 lg:px-[16px] lg:py-[8px] rounded-[30px] transition-colors hover:bg-black overflow-visible shrink-0"
        >
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        <main className="flex-1 flex flex-col gap-[16px] lg:gap-[24px] p-4 lg:p-[24px] lg:pl-[32px] bg-white overflow-hidden w-full">
             ...
             <div className="flex flex-row items-center justify-between w-full gap-3 shrink-0">
                 ...
                 {/* Canvas/Preview Toggle Pill - Flexible width */}
                 <div className="flex-1 sm:flex-none sm:w-[220px] h-[40px] p-[3px] bg-[#FAFAFA] rounded-[30px] flex relative shrink-0">
                      <button 
                 ...
                 {/* Progress Indicator - Next to Toggle */}
