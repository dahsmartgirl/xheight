          ...
          <div className="w-full min-h-full flex flex-col items-center justify-center px-6 py-12 text-center">
             ...
             <div className="flex flex-col sm:flex-row items-center gap-4">
                 ...
                 <button
                    ...
                    className="px-6 py-2.5 bg-white dark:bg-neutral-900 text-neutral-900 dark:text-white border border-gray-200 dark:border-neutral-800 rounded-full text-[15px] font-semibold shadow-sm hover:bg-gray-50 dark:hover:bg-neutral-800 hover:scale-105 active:scale-95"
                 >
                    Join the waitlist
                 </button>
             </div>
